...
class Attention(nn.Module):
    def __init__(self, nx, n_ctx, config, scale=False):
        ...
        self.scale = scale
        self.c_attn = xtuning.MergedLinear(
            nx, n_state * 3, 
            r=config.xtuning_attn_dim,
            xtuning_alpha=config.xtuning_attn_alpha,
            xtuning_dropout=config.xtuning_dropout,
            enable_xtuning=[True, True, True],
            fan_in_fan_out=True,
            merge_weights=False
        )
...
class MLP(nn.Module):
    def __init__(self, n_state, config):  # in MLP: n_state=3072 (4 * n_embd)
        ...
        nx = config.n_embd
        self.c_fc = xtuning.Linear4Module(
            n_state, nx,
            r=config.xtuning_attn_dim,
            xtuning_alpha=config.xtuning_attn_alpha,
            xtuning_dropout=config.xtuning_dropout,
...
class GPT2Config(object):
    def __init__(
        ...
        xtuning_attn_dim=0,
        xtuning_attn_alpha=128,
        xtuning_dropout=0.0,
        xtuning_r_dropout=0.0,
        fix_dropout=0.0,
    ):
        ...
        self.xtuning_attn_dim = xtuning_attn_dim
        self.xtuning_attn_alpha = xtuning_attn_alpha
        self.xtuning_dropout = xtuning_dropout
        self.xtuning_r_dropout = xtuning_r_dropout
