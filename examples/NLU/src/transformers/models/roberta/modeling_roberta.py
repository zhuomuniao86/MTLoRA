...
class RobertaSelfAttention(nn.Module):
    def __init__(self, config):
        ...
        if config.apply_lora:
            print("-----------------------enter RobertaSelfAttention xtuning query-----------------------")
            self.query = xtuning.Linear(config.hidden_size, self.all_head_size, r=config.lora_r, xtuning_alpha=config.lora_alpha, merge_weights=False)
        else:
            self.query = nn.Linear(config.hidden_size, self.all_head_size)
        
        self.key = nn.Linear(config.hidden_size, self.all_head_size)
        if config.apply_lora:
            print("-----------------------enter RobertaSelfAttention xtuning key_proj-----------------------")
        ...
        if config.apply_lora:
            print("-----------------------enter RobertaSelfAttention xtuning value-----------------------")
            self.value = xtuning.Linear(config.hidden_size, self.all_head_size, r=config.lora_r, xtuning_alpha=config.lora_alpha, merge_weights=False)
        else:
...
class RobertaIntermediate(nn.Module):
    def __init__(self, config):
        super().__init__()
        if config.apply_lora:
            print("-----------------------enter RobertaIntermediate xtuning-----------------------")
...
class RobertaOutput(nn.Module):
    def __init__(self, config):
        super().__init__()
        if config.apply_lora:
            print("-----------------------enter RobertaOutput xtuning-----------------------")
